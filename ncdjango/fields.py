...
class BoundingBoxField(models.TextField):
    ...
    def to_python(self, value):
        ...
        try:
            ...
            projection = (
                pyproj.Proj(str(data.get("proj4"))) if data.get("proj4") else None
            )
...
class RasterRendererField(models.TextField):
    ...
    def to_python(self, value):
        ...
        try:
            ...
            kwargs = {
                ...
                "background_color": (
                    Color(*params.get("background_color"))
            ...
            if name == "stretched":
                ...
                kwargs.update({"labels": params.get("labels")})
        except (ValueError, KeyError):
            raise ValidationError("")
    ...
    def get_prep_value(self, value):
        ...
        if isinstance(value, StretchedRenderer):
            name = "stretched"
            params = {"method": value.method, "colorspace": value.colorspace}
